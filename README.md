...
Para poder utilizarlo solo debes necesitar o copilar en `.exe` teniendo ya `AutoHotkey 2.0` solo
es nescario eso

O si quieres usar ya en `.exe` pero tiene algunos bugs pero eso depende que version de windows
tienes
